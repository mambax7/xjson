...
define('_AM_XJSON_PLUGINAVAILABLE', 'JSON Plugins Available');
define('_AM_XJSON_SELECTTABLE', 'Please Select Table to Work with');
define('_AM_XJSON_TABLESAVAILABLE', 'Tables available in database');
define('_AM_XJSON_FIELDOPTIONSFOR', 'Field options within the table selected');
